...
return [
    ...
    'Leave' => 'Leave',
    'News' => 'News',
    'Ongoing Goal Status' => 'Ongoing Goal Status',
    ...
    'model.complete.status' => ':model status should be completed',
    'model.ongoing.status' => ':model status must be ongoing to change into completed'
];
